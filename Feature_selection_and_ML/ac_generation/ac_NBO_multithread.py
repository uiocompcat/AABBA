...
def read_graph(file):
    ...
    path = Path.home()/'Desktop/ABBA_Paper/data/Vaskas_project/uNatQ_graphs'
    ...
    # add feature_identity attribuFAte to nodes and edges
    ...
    #AB_FA_vector, AB_FA_vname = bond_atom_F(G, depth_max, feature_node_uNat, feature_edge_uNat, ac_operator, comp_dict)
...
if __name__ == "__main__":
    ...
    # path to documents
    general_path = Path.home()/'Desktop/ABBA_Paper'

    #path_to_gml = general_path/'../uNatQ_graphs'
    path_to_gml = general_path/'data/Vaskas_project/uNatQ_graphs'
    #path_to_folder = general_path/f'../NBO_{walk}'
    path_to_folder = general_path/f'data/Vaskas_project/NBO_{walk}'
    path_to_disconnected = general_path/'data/Vaskas_project/excluded_graphs/disconnected.txt'
    path_to_test = general_path/'data/test'
