...
def read_graph(file):
    ...
    path = Path.home()/'Desktop/ABBA_Paper/data/Vaskas_project/baseline_graphs'
...
if __name__ == "__main__":
    ...
    path_to_gml = general_path/'data/Vaskas_project/baseline_graphs'
    path_to_folder = general_path/f'data/Vaskas_project/PT_{walk}'
    path_to_disconnected = general_path/'data/excluded_graphs/disconnected.txt'
